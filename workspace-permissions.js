...
export const WORKSPACE_ADMIN_ACTIONS=['view_settings','edit_settings','manage_members','manage_permissions','send_messages','use_sorter','manage_sorter_settings','delete_workspace'];
...
const ADMIN_FULL={view_settings:true,edit_settings:true,manage_members:true,manage_permissions:true,send_messages:true,use_sorter:true,manage_sorter_settings:true,delete_workspace:true};
const ADMIN_DEFAULTS={
  editor:{view_settings:true,edit_settings:false,manage_members:false,manage_permissions:false,send_messages:false,use_sorter:true,manage_sorter_settings:false,delete_workspace:false},
  contributor:{view_settings:false,edit_settings:false,manage_members:false,manage_permissions:false,send_messages:false,use_sorter:false,manage_sorter_settings:false,delete_workspace:false},
  viewer:{view_settings:false,edit_settings:false,manage_members:false,manage_permissions:false,send_messages:false,use_sorter:false,manage_sorter_settings:false,delete_workspace:false},
};
...
export async function effectiveWorkspaceAdminPermissions(workspaceId,role){
  ...
  if(!WORKSPACE_ROLES.includes(role)) return base;
  const row=(await query(`SELECT can_view_settings,can_edit_settings,can_manage_members,can_manage_permissions,can_send_messages,can_use_sorter,can_manage_sorter_settings,can_delete_workspace
  ...
  return row?{
    ...
    use_sorter:row.can_use_sorter,
    manage_sorter_settings:row.can_manage_sorter_settings,
